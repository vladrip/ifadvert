...
('Білборди ІФ, Черкаси', 921000, 100000, false, 1, 'IN_ACTION', 'BILLBOARD', '["link", "link2", "link3"]', '[{"billboardId": 12512, "latitude": 48.89986, "longitude": 24.71317, "direction": "SOUTH", "picture": "link"}, {"billboardId": 161762, "latitude": 49.4671, "longitude": 32.02115, "direction": "EAST", "picture": "link"}]'),
('СТБ 60сек', 11270000, 12000000, false, NULL, 'DISCONTINUED', 'BROADCAST', '["link"]', '[{"channel": "СТБ", "isRadio": false, "nextBroadcast": "2023-10-11T15:10:53.000", "durationSec": 60}]'),
('Бургерна дизайн на машини', 23000, 23000, true, NULL, 'DESIGNING', 'TRANSPORT', '[]', '[]'),
('ITStep Академія реклама транспорт', 1157000, 1160000, false, 2, 'EXECUTING', 'TRANSPORT', '["link"]', '[{"vehicleId": "2351", "type": "METRO", "description": "on left side 1m from the front"}, {"vehicleId": "6375", "type": "METRO", "description": "on left side 5m from back"}, {"vehicleId": "АТ1259ВТ", "type": "BUS", "description": "on back"}, {"vehicleId": "АТ5659ВС", "type": "BUS", "description": "on sides"}, {"vehicleId": "АТ8639СА", "type": "TRUCK", "description": "on sides"}]');
